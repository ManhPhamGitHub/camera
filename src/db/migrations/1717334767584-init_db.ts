...
export class initDb1717334767584 implements MigrationInterface {
  name = 'initDb1717334767584';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`provider\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`providerName\` varchar(255) NOT NULL DEFAULT 1, \`identify\` json NOT NULL, \`fileDirection\` varchar(255) NOT NULL, \`idCamConfig\` varchar(255) NOT NULL, UNIQUE INDEX \`REL_7ea21727d5eebb003243f41274\` (\`idCamConfig\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
